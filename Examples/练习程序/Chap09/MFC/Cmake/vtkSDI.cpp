...
BEGIN_MESSAGE_MAP(CvtkSDIApp, CWinAppEx)
...
// CvtkSDIApp 自定义加载/保存方法

void CvtkSDIApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CvtkSDIApp::LoadCustomState()
{
}

void CvtkSDIApp::SaveCustomState()
{
}
